<template>
  <div class="app-container">
    <el-form :model="queryParams" label="部门列表" ref="queryForm" label-width="75px">
      <el-form-item label="部门列表" prop="dictName" :inline="true" size="small" style="width:340px">
        <!--        <el-select-->
        ...
        <!--          />-->
        <!--        </el-select>-->
        <treeselect v-model="queryParams.cloudCenter" :options="deptOptions" placeholder="请选择归属部门"/>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" width="510px">
      <el-form ref="form" :model="form" :rules="rules" label-width="95px">
        ...
        <el-form-item label="部门列表" prop="cloudCenter">
          <treeselect v-model="form.cloudCenter" :options="deptOptions" placeholder="请选择归属部门"/>
          <!--          <el-select-->
...
<script>
  import {
    ...
    exportType,
    deptListType
  } from '@/api/cloudcenter/region/region'
